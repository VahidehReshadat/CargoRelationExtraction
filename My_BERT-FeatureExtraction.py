...
parser.add_argument("--task", type=str, default='semeval', help='semeval, fewrel')  # MyTRAIN_FILE_Ver9 #NEW_MyTRAIN_FILE_Ver60
...
data_path = './dataset-SCR/Non-Directional/SCR(L)/Test-SCR(L).TXT'
