...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default='fewrel', help='semeval, fewrel') #MyTRAIN_FILE_Ver9 #NEW_MyTRAIN_FILE_Ver60
    #parser.add_argument("--train_data", type=str, default='./data/BiJahat-data/NEW_MyTRAIN_FILE_Ver60.TXT', \
    #                    help="training data .txt file path")       #BiJahat-data/
    #parser.add_argument("--train_data", type=str, default='./data/BiJahat-data/Del_Cluster_Small_Stable/NEW_MyTRAIN_Del_Clus_Small_Stable.TXT', \
    #                    help="training data .txt file path")

    #parser.add_argument("--train_data", type=str,
    #                    default='./data/BiJahat-data/Del_Cluster_Large_Stable/NEW_MyTrain_Del_Clus_Large_Stable.TXT', \
    #                    help="training data .txt file path")

    parser.add_argument("--train_data", type=str,
                        default='./data/khali1.TXT', \
                        help="training data .txt file path")

    #parser.add_argument("--test_data", type=str, default='./data/BiJahat-data/Updated_NEW_TEST_FILE_FULL30.TXT', \
    #                    help="test data .txt file path")
    #parser.add_argument("--test_data", type=str, default='./data/BiJahat-data/Del_Cluster_Small_Stable/NEW_MyTest_Del_Clus_Small_Stable.TXT', \
    #                    help="test data .txt file path")

    #parser.add_argument("--test_data", type=str, default='./data/BiJahat-data/Del_Cluster_Large_Stable/NEW_MyTest_Del_Clus_Large_Stable.TXT', \
    #                    help="test data .txt file path")

    parser.add_argument("--test_data", type=str, default='./data/khali2.TXT', \
                        help="test data .txt file path")
    ...
    parser.add_argument("--num_classes", type=int, default=43, help='number of relation classes')
    ...
    parser.add_argument("--num_epochs", type=int, default=55, help="No of epochs")
